...
# Instruction code for cmpq instruction
...
wordsig ALUSUB	'A_SUB'		     # ALU should sub its arguments
...
################ Fetch Stage     ###################################
#Added ICMPQ to valid instructions and ensured it fetches register IDs.
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, ICMPQ }; #add ICMPQ
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
	     IIRMOVQ, IRMMOVQ, IMRMOVQ, ICMPQ }; #add ICMPQ
...
################ Decode Stage ######################################
#Updated d_srcA and d_srcB to correctly identify source registers for cmpq.

## What register should be used as the A source?
word d_srcA = [
D_icode in { IRRMOVQ, IRMMOVQ, IOPQ, IPUSHQ, ICMPQ  } : D_rA; #add ICMPQ
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, ICMPQ } : D_rB; #add ICMPQ
...
################ Execute Stage #####################################
#Configured the ALU for subtraction and updated condition codes for cmpq.
## Select input A to ALU
word aluA = [
    E_icode in { IRRMOVQ, IOPQ, ICMPQ } : E_valA;
...
E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL,
		     IPUSHQ, IRET, IPOPQ, ICMPQ } : E_valB;
...
word alufun = [
	E_icode == IOPQ : E_ifun;
	E_icode == ICMPQ : ALUSUB;
	1 : ALUADD;
];

## Should the condition codes be updated?
	bool set_cc = E_icode in { IOPQ, ICMPQ } &&
